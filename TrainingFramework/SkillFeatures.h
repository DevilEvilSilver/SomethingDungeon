...
enum class SkillMPCost {
    ...
    SKILL_FREEZE_LV1_MPCOST = 1,
    SKILL_FREEZE_LV2_MPCOST = 1,
    SKILL_FREEZE_LV3_MPCOST = 1
};
...
enum class SkillDamage {
    ...
    SKILL_FIRE_LV2_DMG = 150,
    SKILL_FIRE_LV3_DMG = 200,

    SKILL_FREEZE_LV1_DMG = 100,
    SKILL_FREEZE_LV2_DMG = 150,
